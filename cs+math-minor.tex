...
\newcommand{\linear}{ \textbf{MATH 440} Linear Algebra (spring only, prerequisite: MATH 115) }
...
\begin{itemize}
\item \textbf{MATH 115} Calculus I with Analytic Geometry (fall and spring) \dotfill  5 credits
\end{itemize}


\subsubsection*{\textcolor{black}{For your mathematics classes required by the CS Major Option take}}
\begin{itemize}
\item \textbf{MATH 202} Calculus II with Analytic Geometry (fall and spring,  prerequisite: MATH 115) \dotfill 5 credits
\item  \textbf{MATH 440} Linear Algebra (spring only, prerequisite: MATH 115) \dotfill 3 credits
\end{itemize}

\subsubsection*{\textcolor{black}{For your required Computer Science electives take}}

\begin{itemize}
\item \textbf{MATH 250} Foundations of Math (fall and spring, prerequisite: MATH 115)  \dotfill 3 credits
\item \textbf{MATH 260} Calculus III  (fall and spring, prerequisite: MATH 202) \dotfill 5 credits
\end{itemize}
\vspace{-0.1in}
...
\begin{itemize}
\item \textbf{STAT 441} Probability and Statistics (spring only, prerequisite: MATH 260)  \dotfill  3 credits
\end{itemize}
\vspace{-0.1in}
...
\begin{itemize}
\item \textbf{MATH 413} Discrete Mathematics  (fall only, prerequisite: MATH 250)\dotfill 3 credits
\end{itemize}
\vspace{-0.1in}
...
\begin{itemize}
\item \textbf{MATH 305}	Differential Equations (spring only, prerequisite: MATH 260) \dotfill 	3 credits
\item \textbf{MATH 350}	Abstract Algebra (spring only, prerequisite: MATH 260) \dotfill 	3 credits
\item \textbf{MATH 365}	Complex Analysis (spring only,  prerequisite: MATH 260) \dotfill 3 credits
\item \textbf{MATH 460}	Advanced Calculus I  (fall only,   prerequisite: MATH 250) \dotfill 3 credits

\end{itemize}

\subsubsection*{\textcolor{black}{For your  Math Elective take \emph{one} of}}
\begin{itemize}
\item \textbf{MATH 413}     Discrete Mathematics  (fall only, prerequisite: MATH 260)  \dotfill 3 credits
\item \textbf{MATH 420}   Numerical Analysis   (spring only, prerequisite: MATH 260)\dotfill 3 credits
\end{itemize}
...
\begin{itemize}
 \item \textbf{MATH 202} Calculus II with Analytic Geometry (fall and spring,  prerequisite: MATH 115) \dotfill 5 credits
 \item \textbf{MATH 260} Calculus III (fall and spring,  prerequisite: MATH 260) \dotfill 5 credits
 \item \textbf{MATH 305} Differential Equations III (spring only,  prerequisite: MATH 260) \dotfill 3 credits
\end{itemize}
...
\begin{itemize}
\item \textbf{MATH 350} Abstract Algebra (spring only, prerequisite: MATH 250) \dotfill 3 credits
\end{itemize}
